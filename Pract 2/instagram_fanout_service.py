"""
Практичне завдання 2 — Архітектура програмного забезпечення
Тема: Архітектура Instagram
Студент: Макаров Дмитро, ПЗПІ-23-7

Демонстрація роботи Fanout Service в Instagram:
- Отримання підписників з TAO (графова БД)
- Запис нового поста у стрічки підписників (Cassandra)
- Обробка подій з черги Kafka
- Dead Letter Queue (DLQ) для помилок
